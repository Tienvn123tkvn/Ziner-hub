...
local NexusApi = "KIDO HUB"
local filename = "BloxFruits.json"
local foldername = "KIDO HUB"
_G.Settings = {
...
Title.Text = "KIDO HUB| ".."<font color='rgb(0, 0, 255)'>[BETA VERSION]</font> 🇻🇳"
Title.RichText = true;
...
Main_Page:Label("Welcome To KIDO Hub")
